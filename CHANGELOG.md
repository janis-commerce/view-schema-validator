...
- Errors modal at interactions components
...
- Support for target at chip components
- key `maxPreviewColumns` to show fixed quantity columns in preview

## [3.5.0] - 2025-09-25

### Added

- hideApplyButton boolean in edit schemas
...
- default value **true** for canRefresh in Browse schema
...
- common link properties for several schemas
