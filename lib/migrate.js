...
function convertFile(inputFile, outputFile, ymljs, currentFileRelDir) {
	...
	const packageRequire = 'const { defineView } = require(\'@janiscommerce/view-schema-validator\');';
	...
	if(uniqueRefs.length > 0) {
		...
		jsContent += 'module.exports = defineView(' + source + ');\n';
	} else {
		jsContent += packageRequire + '\n\n';
		jsContent += 'module.exports = defineView(' + toJsSource(parsed) + ');\n';
	}
